@extends('layouts.app')
@section('title' ,  Lang::get('lang.adminpanel') . ' | '. Lang::get('lang.editCategory'))
@push('attr-body')
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title mb-0">@lang('lang.editCategory')</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"><span>@lang('lang.editCategory')</span></li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <form action="{{route('category.update', $category->id)}}" method="POST" enctype="multipart/form-data">
                                            <h4 class="form-section"><i class="fas fa-list"></i> @lang('lang.editCategory')</h4>
                                            @csrf
                                            ...
                                            <div class="row">
                                                <fieldset class="form-group col-12 mb-2">
                                                    ...
                                                    <img class="rounded img-thumbnail mt-1" src="{{ asset('storage/'.$category->image) }}">
                                                </fieldset>
                                            </div>
