                            ...
                            <div class="card">
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <form>
                                            <h4 class="form-section"><i class="fas fa-users"></i> @lang('lang.trash')</h4>
                                        </form>
                                                        ...
                                                        <div class="btn-group mr-1 mb-1">
                                                            ...
                                                            <div class="dropdown-menu" style="right: -150% !important;">
                                                                <a class="dropdown-item"
                                                                   href="{{route('user.undo', $user->id)}}"><i class="fas fa-undo mr-1"></i> @lang('lang.undo')</a>
                                                                <a class="dropdown-item text-danger confirm-text" data-user="{{$user->id}}"
                                                                   href="{{route('user.forceDelete', $user->id)}}" onclick="event.preventDefault();"
                                                                ><i class="fas fa-trash mr-1"></i> @lang('lang.delete')</a>
                                                            </div>
                                                        </div>
                                                        <form id="delete-form-{{$user->id}}" action="{{ route('user.forceDelete', $user->id) }}" method="POST" style="display: none;">
                                                            @csrf
