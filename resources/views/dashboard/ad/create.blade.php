@extends('layouts.app')
@section('title' ,  Lang::get('lang.adminpanel') . ' | '. Lang::get('lang.createAd'))
@push('attr-body')
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2">
                <h3 class="content-header-title mb-0">@lang('lang.createAd')</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><span>@lang('lang.createAd')</span></li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form action="{{route('ad.store')}}" method="POST" enctype="multipart/form-data">
                                        <h4 class="form-section"><i class="fas fa-ad"></i> @lang('lang.createAd')</h4>
                                        @csrf
                                            ...
                                            <div class="col-md-6">
                                                <fieldset class="form-group">
                                                    ...
                                                    <input type="text" id="url" class="form-control @error('url') is-invalid text-danger @enderror"
                                                           placeholder="@lang('lang.url')" name="url" value="{{old('url')}}">
                                                    @error('url')
                                                    <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
