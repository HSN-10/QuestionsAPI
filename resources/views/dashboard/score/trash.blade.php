                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-none d-md-block">
                                                            <div class="btn-group">
                                                                <a href="{{route('score.undo', [$category->id, $score->id])}}" class="btn btn-group btn-info square">
                                                                    <i class="fas fa-undo mr-1"></i> @lang('lang.undo')
                                                                </a>
                                                                <a href="{{route('score.forceDelete', [$category->id, $score->id])}}" class="btn btn-group btn-danger square confirm-text"
                                                            ...
                                                            <div class="btn-group mr-1 mb-1">
                                                                ...
                                                                <div class="dropdown-menu" style="right: -150% !important;">
                                                                    <a class="dropdown-item"
                                                                       href="{{route('score.undo', [$category->id, $score->id])}}">
                                                                        <i class="fas fa-undo mr-1"></i> @lang('lang.undo')
                                                                    </a>
                                                                    <a class="dropdown-item text-danger confirm-text"
                                                                       href="{{ route('score.forceDelete', [$category->id, $score->id]) }}"
                                                                       onclick="event.preventDefault();" data-score="{{$score->id}}">
                                                                        <i class="fas fa-trash mr-1"></i> @lang('lang.forceDelete')</a>
                                                                    <form id="forceDelete-form-{{$score->id}}" action="{{ route('score.forceDelete', [$category->id, $score->id]) }}"
        ...
        $(".confirm-text").on("click", function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    setTimeout(()=>{
                        document.getElementById('forceDelete-form-' + score).submit();
                    },1500)
